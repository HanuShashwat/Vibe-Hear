                ...
                children: [
                  Text.rich(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: "Vibe Hear is an offline, assistive Android application designed for "
                              "completely deaf individuals. It transforms spoken words — like your "
                              "name or emergency key words — into personalized vibration alerts using your"
                              " phone’s in-built microphone and vibration motor. Whether someone calls"
                              " you, says “Help,” or reminds you to take your medicine, the app picks "
                              "up these sounds and notifies you through distinct vibration patterns "
                        ...
                        TextSpan(
                          text: "The app works entirely offline, "
                            "prioritizing your privacy and ensuring fast response without needing"
                            " internet access. With features like keyword-based vibration alerts, "
                            "real-time speech-to-text transcription, and full user customization,"
                            " Vibe Hear helps deaf users stay aware, safe, and more connected to "
                            "their surroundings — anytime, anywhere.",
                          style: TextStyle(
                            color: Colors.grey.shade800,
                            height: 1.3,
                          ),
